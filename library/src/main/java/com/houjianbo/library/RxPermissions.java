...
public class RxPermissions {
    ...
    private Observable<Permission> requestImplementation(final String... permissions) {
        ...
        Observable<Permission>[] permissionsArray= (Observable<Permission>[])list.toArray();
        return Observable.concat(Observable.fromArray(permissionsArray));
    }
